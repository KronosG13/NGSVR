...
NGSVR source code is licensed under the **MIT License**. However, this project is built on Unreal Engine 5, which is governed by Epic's [Unreal Engine EULA](https://www.unrealengine.com/en-US/eula/unreal). Contributors and users must comply with both.
